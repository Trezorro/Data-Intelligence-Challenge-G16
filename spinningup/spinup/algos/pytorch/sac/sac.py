...
def sac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    ac = actor_critic(device, **ac_kwargs)
    ac_targ = deepcopy(ac)
    ...
    def compute_loss_q(data):
        field, agent_center, a, r, field2, agent_center2, d = data['obs'], data['pos_buf'], data['act'], data['rew'], \
                                                              data['obs2'], data['pos_buf2'], data['done']
